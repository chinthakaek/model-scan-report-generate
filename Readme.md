...
Valid client credentials generated through the Palo Alto Networks SCM Portal
...
Bash
touch .env
Populate the .env file with your verified Prisma instance secrets:
...
Usage
Execute the report orchestration manager by parsing a valid Prisma Scan UUID string sequence as a CLI system argument:
